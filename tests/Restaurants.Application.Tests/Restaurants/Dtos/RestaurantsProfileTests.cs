...
using Restaurants.Application.Restaurants.Commands.UpdateResturant;
...
public class RestaurantsProfileTests
{
    ...
    public void CreateMap_ForRestaurantToRestaurantDto_MapsCorrectly()
    {
        ...
        restaurantDto.Id.Should().Be(restuarant.Id);
        restaurantDto.Name.Should().Be(restuarant.Name);
        restaurantDto.Description.Should().Be(restuarant.Description);
        restaurantDto.Category.Should().Be(restuarant.Category);
        restaurantDto.HasDelivery.Should().Be(restuarant.HasDelivery);
